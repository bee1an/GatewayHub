...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-primary': 'btn bg-lime text-lime-text border-lime/20 shadow-[0_1px_2px_rgba(0,0,0,0.15)] hover:not-disabled:bg-lime/85 hover:not-disabled:text-lime-text hover:not-disabled:border-lime/30 hover:not-disabled:shadow-[0_2px_6px_rgba(0,0,0,0.2)]',
    'btn-ghost': 'btn bg-transparent text-storm border-transparent hover:not-disabled:bg-charcoal/70 hover:not-disabled:text-porcelain hover:not-disabled:border-charcoal',
    'btn-danger': 'btn bg-transparent text-red border-red/30 hover:not-disabled:bg-red/10 hover:not-disabled:text-red hover:not-disabled:border-red/50',
    ...
    'input-base': 'w-full px-3.5 py-3 rounded-[var(--radius-md)] border border-charcoal bg-transparent text-porcelain text-[13px] outline-none transition-colors duration-100 placeholder:text-fog focus:border-gunmetal',
    ...
    'badge': 'inline-flex items-center gap-1.5 px-1.5 py-0.5 rounded-[var(--radius-sm)+2px] text-[12px] font-[510] bg-gunmetal text-storm',
    ...
    'stat-card-lg': 'rounded-[var(--radius-md)] bg-graphite p-4 shadow-[var(--shadow-subtle)] flex flex-col gap-1',
    'divider': 'border-t border-charcoal',
    'sidebar-item': 'flex items-center gap-2.5 px-3 py-1.5 rounded-[var(--radius-md)] text-[13px] text-storm cursor-pointer transition-colors duration-100 hover:bg-charcoal hover:text-porcelain',
    'sidebar-item-active': 'flex items-center gap-2.5 px-3 py-1.5 rounded-[var(--radius-md)] text-[13px] text-porcelain bg-charcoal cursor-pointer',
    'log-row': 'flex items-center gap-3 px-3 py-1.5 text-[13px] font-mono border-b border-charcoal/50 hover:bg-slate/50 cursor-pointer transition-colors duration-75',
    ...
    'modal-content': 'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[85vh] overflow-y-auto bg-graphite/95 border border-charcoal rounded-[var(--radius-lg)] shadow-[var(--shadow-xl)] p-5 animate-fade-in',
    'tab-list': 'flex gap-0 bg-charcoal rounded-[var(--radius-md)] p-0.5',
    'tab-trigger': 'flex-1 px-3 py-1.5 rounded-[var(--radius-sm)] text-[12px] font-[510] text-fog transition-colors data-[state=active]:bg-slate data-[state=active]:text-porcelain hover:text-storm',
  }
})
