...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        // ---- cli login ----
        "cli_detecting" => "Detecting {bin}…",
        "cli_not_found" => "{bin} not found on this machine",
        "cli_install_hint" => "Install the CLI first, then reopen this dialog.",
        "cli_found" => "Found: {path}",
        "cli_login" => "Log in via CLI",
        "cli_import_current" => "Import current CLI auth",
        "cli_open_hint" => "Open this link in a browser and enter the code:",
        "cli_open_hint_plain" => "Open this link in a browser to sign in:",
        "cli_wait" => "Waiting for verification…",
        "cli_success" => "Account imported via CLI",
        "cli_failed" => "Login failed (exit code {code})",
        "coming_soon" => "Coming soon",
        "discover_tab" => "Discover",
        "discover_tip" => "Local credentials found on this machine:",
        "discover_scanning" => "Scanning local credentials…",
        "discover_empty" => "No local credentials found",
        "discover_exists" => "exists",
        "discover_updatable" => "updatable",
        "discover_add" => "Add ({n})",
        "discover_imported" => "Imported {added}, updated {updated}",
        "discover_none" => "Nothing to import",
        ...
        "models_refreshed" => "Refreshed — {n} models",
...
fn zh(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        // ---- cli login ----
        "cli_detecting" => "正在检测 {bin}…",
        "cli_not_found" => "未检测到 {bin}",
        "cli_install_hint" => "请先安装该 CLI，然后重新打开此对话框。",
        "cli_found" => "已找到：{path}",
        "cli_login" => "通过 CLI 登录",
        "cli_import_current" => "导入当前 CLI 凭据",
        "cli_open_hint" => "在浏览器中打开链接并输入验证码：",
        "cli_open_hint_plain" => "在浏览器中打开链接完成登录：",
        "cli_wait" => "等待验证完成…",
        "cli_success" => "已通过 CLI 导入账号",
        "cli_failed" => "登录失败（退出码 {code}）",
        "coming_soon" => "敬请期待",
        "discover_tab" => "本机扫描",
        "discover_tip" => "在本机发现以下凭据：",
        "discover_scanning" => "正在扫描本机凭据…",
        "discover_empty" => "未找到本机凭据",
        "discover_exists" => "已存在",
        "discover_updatable" => "可更新",
        "discover_add" => "添加（{n}）",
        "discover_imported" => "已导入 {added} 个，更新 {updated} 个",
        "discover_none" => "没有可导入的账号",
