...
impl AppRoot {
    pub fn new(service: Arc<GatewayService>, _window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        Self {
            ...
            pg_stream: true,
            pg_input,
            pg_msgs: Arc::new(Vec::new()),
            pg_next_msg: 1,
            pg_pending: false,
            pg_cancel: None,
            pg_scroller: cx.new(|cx| MessageScrollerState::new(0, cx)),
