const en = {
  ...
  dashboard: {
    title: 'Dashboard',
    desc: 'Control the gateway and run quick tests',
    running: 'Running',
    stopped: 'Stopped',
    start: 'Start',
    stop: 'Stop',
    providersReady: '{{ready}}/{{total}} ready',
    errors: '{{count}} errors',
    quickTest: 'Quick Test',
    quickTestDesc: 'Send a request straight to the gateway',
    quickTestFailed: 'Test request failed',
    model: 'Model',
    apiKey: 'API Key',
    prompt: 'Prompt',
    ...
    sending: 'Sending...',
    response: 'Response',
    responseEmpty: 'No content returned',
    startFirst: 'Start the gateway first',
    noKey: 'No API key — generate one in API Keys',
