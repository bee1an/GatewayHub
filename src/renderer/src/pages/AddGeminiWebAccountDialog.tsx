...
export function AddGeminiWebAccountDialog({
  open,
  onOpenChange,
  onImported
}: {
  ...
  async function handleImport(): Promise<void> {
    ...
    setResult(null)
    try {
      const r = await window.api.gateway.importGeminiWebJson(jsonText)
      setResult({
        added: r.added,
        skipped: r.skipped,
  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange} title={t('addAccount.geminiWebTitle')}>
