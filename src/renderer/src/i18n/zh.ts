const zh = {
  ...
  settings: {
    ...
    windsurfDesc: '配置 Windsurf language_server、API 端点、代理与超时行为。',
    windsurfApiServerUrl: 'API Server URL',
    windsurfInferenceApiServerUrl: 'Inference API URL',
    windsurfLanguageServerPath: 'language_server 路径',
    windsurfCodeiumDir: 'Codeium 目录',
    windsurfProxy: '代理 URL',
    windsurfDetectProxy: '自动探测代理',
    windsurfDetectProxyDesc: '将自动代理探测开关传给 Windsurf language_server。',
    windsurfFirstTokenTimeout: '首 token 超时（秒）',
    windsurfStreamingTimeout: '流式空闲超时（秒）',
    windsurfLaunchTimeout: '启动超时（秒）',
    windsurfMaxRetries: '最大重试次数',
    autoStart: '自动启动',
