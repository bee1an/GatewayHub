const en = {
  ...
  settings: {
    ...
    windsurfTitle: 'Windsurf Provider',
    windsurfDesc: 'Configure Windsurf language_server, API endpoints, proxy, and timeout behavior.',
    windsurfApiServerUrl: 'API server URL',
    windsurfInferenceApiServerUrl: 'Inference API URL',
    windsurfLanguageServerPath: 'language_server path',
    windsurfCodeiumDir: 'Codeium dir',
    windsurfProxy: 'Proxy URL',
    windsurfDetectProxy: 'Detect proxy',
    windsurfDetectProxyDesc: 'Pass automatic proxy detection to Windsurf language_server.',
    windsurfFirstTokenTimeout: 'First token timeout (s)',
    windsurfStreamingTimeout: 'Streaming idle timeout (s)',
    windsurfLaunchTimeout: 'Launch timeout (s)',
    windsurfMaxRetries: 'Max retries',
